...
3. Download project from github(https://github.com/adityapaul04/bloodbank-management-system-php-mysql.git).

   OR follow gitbash commands <br>
     ```t
         i>cd C:\\xampp\htdocs\
        ii>git clone https://github.com/adityapaul04/bloodbank-management-system-php-mysql.git
